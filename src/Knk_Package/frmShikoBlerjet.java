...
public class frmShikoBlerjet extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmShikoBlerjet frame = new frmShikoBlerjet();
	...
	public void updateTable1()
	{
		try 
		{
			String sql="select b.bId as 'ID', v.brendi as 'Brendi', v.modeli as 'Modeli', v.cmimi as 'Çmimi (€)', b.dataBlerjes as 'Data e blerjes', b.kohaBlerjes as 'Koha e blerjes' from veturat v, blerjet b where v.vid = b.vid";
			pst=conn.prepareStatement(sql);
			//objekti qe mundeson ekzekutimin e querit dhe vendosjen e rez ne objektin res.
			res=pst.executeQuery();
			
			tblBlerjet.setModel(DbUtils.resultSetToTableModel(res));
	 ...
	 * Create the frame.
	 */
	public frmShikoBlerjet() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(frmShikoBlerjet.class.getResource("/img2/icons/1.png")));
		...
		tblBlerjet = new JTable();
		scrollPane.setViewportView(tblBlerjet);
		tblBlerjet.setEnabled(false);
		tblBlerjet.setRowMargin(2);
		tblBlerjet.setRowHeight(20);
		tblBlerjet.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		JLabel lblListaEBlerjeve = new JLabel(messages.getString("lblListaEBlerjeve"));
		lblListaEBlerjeve.setForeground(Color.WHITE);
		lblListaEBlerjeve.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblListaEBlerjeve.setBounds(143, 29, 152, 25);
		panel.add(lblListaEBlerjeve);
		...
		txtSearch.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) 
			{
				try 
				{
					...
					String query1="select b.bId as 'ID', v.brendi as 'Brendi', v.modeli as 'Modeli', v.cmimi as 'Çmimi (€)', b.dataBlerjes as 'Data e blerjes', b.kohaBlerjes as 'Koha e blerjes' from blerjet where brendi like '"+txtSearch.getText()+"%'";
